        ...
        <SectionContainer className="relative z-10 py-12 md:py-20">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <p className="text-md md:text-lg text-white/90 mb-8">
              Since 2007 we connect Nigerian markets to Asian suppliers — procurement, clearing, and logistics handled end-to-end.
            </p>
      ...
      <SectionContainer>
        <div className="grid md:grid-cols-3 gap-8 my-12">
          <div className="text-center">
            ...
            <p className="text-muted-foreground text-sm">On-the-ground teams in Lagos for inspections and procurement.</p>
          </div>
          <div className="text-center">
            <div className="w-20 h-20 rounded-lg overflow-hidden mx-auto mb-4">
            ...
            <h3 className="text-xl font-semibold mb-2">Documentation & Printing</h3>
